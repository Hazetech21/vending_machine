    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['user', 'token'], name='active_sess_user_id_91a12e_idx')],
            },
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('amount_available', models.IntegerField(validators=[django.core.validators.MinValueValidator(0)])),
                ('cost', models.IntegerField(validators=[django.core.validators.MinValueValidator(5)])),
                ('created_at', models.DateTimeField(auto_now_add=True)),
            ...
            options={
                'db_table': 'products',
                'indexes': [models.Index(fields=['seller'], name='products_seller__c70854_idx')],
            },
        ),
    ]
